    ...
    <>
      <nav>
        ...
        <div className="navCss">
         ...
         <li>  {currentUser ? <button type="button" class="btn btn-success" onClick={handleLogout}> Logout </button>:
                <button type="button" class="btn btn-success"><Link to="/blogs">LogIn</Link></button>}
            {/* <button><Link to="/blogs">LogIn</Link> </button> } */}
            </li>
